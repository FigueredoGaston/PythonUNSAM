...
def f_principal():
    ...
    #Poner low_memory=False me TAPÓ un warning que me surgía al abrir un archivo
    #No encontre una forma eficiente de solucionarlo
    ...
    df_tipas_veredas.columns = ['altura_tot', 'diametro', 'nombre_cie'] #Cambio el nombre de las columnas
    df_tipas_parques = df_tipas_parques.assign(ambiente = 'parque')#agrego una columna con el valor parque
    df_tipas_veredas = df_tipas_veredas.assign(ambiente = 'vereda')#agrego una columna con el valor vereda
